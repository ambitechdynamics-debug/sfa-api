...
const FAQ = [
  ...
  { q: "Puis-je importer ma charte graphique ?", a: "La fonction Mémoires de marque est en cours de développement. Importez logo, couleurs, polices ; l'IA mémorise et applique." },
